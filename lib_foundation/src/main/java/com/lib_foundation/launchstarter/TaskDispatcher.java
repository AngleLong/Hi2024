...
import com.lib_foundation.launchstarter.sort.TaskSortUtil;
import com.lib_foundation.launchstarter.stat.TaskStat;
import com.lib_foundation.launchstarter.task.DispatchRunnable;
import com.lib_foundation.launchstarter.task.Task;
import com.lib_foundation.launchstarter.task.TaskCallBack;
import com.lib_foundation.launchstarter.utils.DispatcherLog;
import com.lib_foundation.launchstarter.utils.Utils;
...
public class TaskDispatcher {
    ...
    public void await() {
        try {
            ...
            DispatcherLog.i("TaskDispatcher InterruptedException Error" + e);
        }
    }
